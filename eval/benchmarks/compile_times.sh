...
temci short exec -wd "x10i startup/Startup.x10 -mtarget=i686-invasic-irtss -o out" --runs 50 --out temci_output/compile_x10.yaml
temci short exec -wd "x10i startup/Startup.x10 -mtarget=i686-invasic-irtss -o out -O3" --runs 50 --out temci_output/compile_x10_opt.yaml
