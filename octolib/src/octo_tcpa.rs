...
extern {
    ...
    fn __tcpa_proxy_invade(fut: *tcpa_invade_future_t, quantity0: pe_quantity_t, quantity1: pe_quantity_t) -> i32;

    #[link_name="tcpa_invade_future_force"]
    fn __tcpa_invade_future_force(fut: *tcpa_invade_future_t) -> tcpa_proxy_claim_t;

    #[link_name="tcpa_proxy_retreat"]
    fn __tcpa_proxy_retreat(claim: tcpa_proxy_claim_t) -> i32;

    #[link_name="tcpa_proxy_infect"]
    fn __tcpa_proxy_infect(claim: tcpa_proxy_claim_t, fut: *tcpa_infect_future_t, input: *const void, i_size: i32, binary: *const void, b_size: i32) -> i32;

    #[link_name="tcpa_proxy_reinfect"]
    fn __tcpa_proxy_reinfect(claim: tcpa_proxy_claim_t, fut: *tcpa_infect_future_t, input: *const void, i_size: i32) -> i32;

    #[link_name="tcpa_infect_future_force"]
    fn __tcpa_infect_future_force(fut: *tcpa_infect_future_t) -> tcpa_infect_response_t;
    ...
    fn __tcpa_get_output_stream(claim: tcpa_proxy_claim_t, fut: *tcpa_get_output_future_t, input: *const void) -> i32;

    #[link_name="tcpa_get_output_future_force"]
    fn __tcpa_get_output_future_force(fut: *tcpa_get_output_future_t) -> tcpa_output_transfer_confirm_t;
...
pub fn tcpa_proxy_invade(fut: *tcpa_invade_future_t, quantity0: pe_quantity_t, quantity1: pe_quantity_t) -> i32 {
    unsafe {
        __tcpa_proxy_invade(fut, quantity0, quantity1)
    }
}

pub fn tcpa_invade_future_force(fut: *tcpa_invade_future_t) -> tcpa_proxy_claim_t {
    unsafe {
...
pub fn tcpa_proxy_infect(claim: tcpa_proxy_claim_t, fut: *tcpa_infect_future_t, input: *const void, i_size: i32, binary: *const void, b_size: i32) -> i32 {
    unsafe {
        __tcpa_proxy_infect(claim, fut, input, i_size, binary, b_size)
    }
}

pub fn tcpa_proxy_reinfect(claim: tcpa_proxy_claim_t, fut: *tcpa_infect_future_t, input: *const void, i_size: i32) -> i32 {
    unsafe {
        __tcpa_proxy_reinfect(claim, fut, input, i_size)
    }
}

pub fn tcpa_infect_future_force(fut: *tcpa_infect_future_t) -> tcpa_infect_response_t {
    unsafe {
...
pub fn tcpa_get_output_stream(claim: tcpa_proxy_claim_t, fut: *tcpa_get_output_future_t, input: *const void) -> i32 {
    unsafe {
        __tcpa_get_output_stream(claim, fut, input)
    }
}

pub fn tcpa_get_output_future_force(fut: *tcpa_get_output_future_t) -> tcpa_output_transfer_confirm_t {
    unsafe {
